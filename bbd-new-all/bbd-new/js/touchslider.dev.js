...
(function(window, undefined){
	...
	TouchSlider.fn=TouchSlider.prototype={
		...
		slide:function(index, speed){
			//显示图片下方的文字********************begin********************
			var indexpName = $('#indexSlider').find('a').eq(index).attr('indexpName') ;
			var indexName_html = '<font color="#666666" style="font-size: 0.8em;">'+indexpName+'</font>' ;
			$('#indexpName').html(indexName_html) ;
			//显示图片下方的文字********************end**********************
