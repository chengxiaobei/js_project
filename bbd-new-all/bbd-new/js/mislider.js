			...
			.children( "a" )
				.on( "click", function( e ) {
  				...
  				// // // 			// $("#btn_next").click();
						...
						$('.mis-prev').css('display',"none");
						// $(".mis-prev").css("cursor", "default");
						// timer = setTimeout(function(){
						$('.index-text').slickNext();
						 e.stopPropagation();
						$('.mis-prev').css('display',"block");
						// $('.mis-prev').css("cursor","pointer");
  				// 		}, 230);
  						// clearInterval(timer);
						...
						o.transition( o.indexCurrent + Math.abs( o.increment ),
							false, o.autoplayOn( o.increment ), true );
						$('.mis-next').css('display',"none");
						$('.index-text').slickPrev();
						e.stopPropagation();
						$('.mis-next').css('display',"block");
					}
