  ...
  '</div>'+
	...
	'<div class="form-body">'+
		...
		'<div class="map-body">'+
			...
			'<div class="map-list">'+
				'<ul>'+
					'<li><a href="hx-pro.html">> C2B移动云平台</a></li>'+
					'<li><a href="hx-pro.html?p=B2Bdiv">> B2B移动云平台</a></li>'+
					'<li><a href="hx-pro.html?p=DSJdiv">> 大数据平台</a></li>'+
					'<li><a href="hx-pro.html?p=JXCdiv">> 移动进销存平台</a></li>'+
					'<li><a href="hx-pro.html?p=QJDdiv">> 经销商旗舰店</a></li>'+
				'</ul>'+
			'</div>'+
			'<h2>商品案例</h2>'+
			'<div class="map-list">'+
				'<ul>'+
					'<li><a href="shangyeanli.html#sy-linefour">> 互联网+航空</a></li>'+
					'<li><a href="shangyeanli.html?p=yiliaoli">> 互联网+医疗</a></li>'+
					'<li><a href="shangyeanli.html?p=yangzyli">> 互联网+养殖业</a></li>'+
					'<li><a href="shangyeanli.html?p=meizli">> 互联网+美妆</a></li>'+
					'<li><a href="shangyeanli.html?p=bangli">> 互联网+办公</a></li>'+
					'<li><a href="shangyeanli.html?p=zhengfli">> 互联网+政府</a></li>'+
				'</ul>'+
			'</div>'+
			'<div class="map-left">'+
			'<h2>关于佰邦达</h2>'+
			'<div class="map-list">'+
				'<ul>'+	
					'<li><a href="bbd-one.html">> 公司文化</a></li>'+
					'<li><a href="bbd-one.html?p=fzlc">> 发展历程</a></li>'+
					'<li><a href="bbd-one.html?p=hydw">> 行业地位</a></li>'+
					'<li><a href="bbd-one.html?p=bfkh">> 部分客户</a></li>'+
				'</ul>'+
			'</div>'+
			'</div>'+
		  '</div>'+
          ...
          '<div class="form-body">'+
			'<div class="contact-wrap">'+
				'<ul class="left contact-list">'+
					...
					'</li>'+
					'<li>'+
						'<img src="../images/alertlocation.png"/style="padding-left: 8px;">'+
                        '<div class="clearf"></div>'+
						'<ul>'+
