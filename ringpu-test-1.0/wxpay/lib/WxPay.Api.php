...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetSpbill_create_ip("180.213.154.194");//终端ip	  
		//$inputObj->SetSpbill_create_ip("1.1.1.1");  	    
		$inputObj->SetNonce_str("6dc408a5a3bac15475a94261814d6c54");
		...
		$xm = "=================================================";
		file_put_contents("../logs/log.log", $xm, FILE_APPEND);
		file_put_contents("../logs/log.log", $xml, FILE_APPEND);
		file_put_contents("../logs/log.log", $xm, FILE_APPEND);
