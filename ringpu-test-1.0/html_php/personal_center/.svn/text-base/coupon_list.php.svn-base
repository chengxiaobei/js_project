...
<body class="main-body2">
  <div class="wrap" id="wrap1">
    <script id="coupon_list_tpl" type="text/x-jsmart-tmpl"> 
      ...
      <section class="main-section" id="coupon_list">
        <!--使用规则-->
        <div class="yhq-userule">
          <a href="javascript:void(0);" id="coupon_use_rules">使用规则</a>
        </div>
        <!--优惠券1-->
        {if $list.length>0}
          {foreach $list as $key=>$value}
            <div class="yhq-redbox">
              <div class="yhq-discount" style="font-weight:bold;">
                <div class="left">
        ...
        {/if}
        <!--优惠券2-->
        <div class="yhq-redbox" style="display:none;">
          <div class="yhq-discount">
            <div class="left">折扣券</div>
            <div class="right">50元</div>
            <div class="clearf"></div>
          </div>
          <div class="yhq-indate">有效期至2013-09-09</div>
          <div class="yhq-limit">每个订单仅限一张，不可与其他优惠同时使用</div>
        </div>
      </section>
    </script>
  </div>
  ...
  <!-- 优惠券使用规则 -->
   <div class="wrap" id="wrap2" style="display:none;">
    ...
    <section class="main-section">
      <div class="center-mt yhq-rule-bg">
      <ul>
        <li>
...
<script type="text/javascript" src="../../public/js/common/require.min.js" 
    data-main="../../public/js/modules/personal_center/coupon_list.js"></script>
