...
<body class="downlo-appp-body">
  <div class="wrap">
    <section>
      ...
      <!--下载的二维码左右结构-->
      <!--  <div class="yzb-down-saomiao yzb-down-lanzi">
        <div class="yzb-down-saomiao-main">
          <h2 class="an-zhuo-text">（安卓版）</h2>
          <div class="left yzb-saomiao-left download_yzh">
            <p>养殖户端</p>
            <img src="../../public/images/hd-yzh-logo.png">
            <a >立即下载</a>
          </div>
          <div class="left yzb-saomiao-left download_sy">
            <p style="">兽医端</p>
            <img src="../../public/images/hd-syd-logo.png">
            <a>立即下载</a>
          </div>
          <div class="right yzb-saomiao-left download_jsx">
            <p>内部经销商端</p>
            <img src="../../public/images/hd-jxs-logo.png">
            <a>立即下载</a>
          </div>
      ...
      <!--立即下载按钮-->
      <a class="download-btn download_jsx">立即免费下载</a>
	...
	var url='https://m.ringpu.com/ringpu/html_php/download/downloadApp_jxs.php';
	commonAjax(urlshareinit , {url:url}).then(function(data){
 		...
 		$('.download_jsx').on('click',function(){
			if(ua.match(/MicroMessenger/i) == 'micromessenger'){
		       $('#showdownload').show();
		    }else{
		       window.location.href="http://m.ringpu.com/download/apps/RingpuInnerAgent-lastest.apk"
		    }
 		})
